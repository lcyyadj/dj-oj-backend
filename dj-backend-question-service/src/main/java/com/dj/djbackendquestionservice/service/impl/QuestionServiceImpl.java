...
import com.dj.djbackendquestionservice.mapper.QuestionMapper;
...
import com.dj.ojbackendmodel.model.dto.question.QuestionQueryRequest;
...
* @createDate 2023-12-22 13:37:28
*/
@Service
...
//        Integer isDelete = question.getIsDelete();
        ...
        if (StringUtils.isNotBlank(judgeConfig) && judgeConfig.length() > 8192) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "判题条件过长");
        }
    }
